...
public class OrderItemServiceImpl implements OrderItemService{
	...
	public OrderItem insertOrderItem(OrderItem orderItem, int itemId, int customerId) {
		...
		{
			existItems.setQuantity( orderItem.getQuantity()+1);
...
//		}
	...
	@Override
	public void deleteCartById(int orderItemId) {
		...
		if(orderItemRepository.existsById(orderItemId))
		{
			...
			throw new CustomerNotFoundException("Order id is not found with "+orderItemId);
		}
