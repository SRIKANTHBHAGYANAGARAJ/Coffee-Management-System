...
public class CustomerController {
	...
	public ResponseEntity<Customer>  updateCustomerById(@PathVariable int customerId, @RequestBody Customer customer)
	{
		return new ResponseEntity<Customer>( customerServiceImpl.updateCustomerById(customer, customerId), HttpStatus.OK);
	}
