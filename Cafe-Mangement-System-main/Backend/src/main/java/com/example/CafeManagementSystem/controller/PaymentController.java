...
public class PaymentController {
	...
	public ResponseEntity<Payment> insertPayment(@RequestBody Payment payment, @PathVariable int orderId, @PathVariable int customerId) {

		return new ResponseEntity<Payment>(paymentServiceImpl.insertPayment(payment, orderId, customerId), HttpStatus.CREATED);
	}
